...
/* require controllers  */
const { startProviderPaymentGatewaysRoutes } = require("./providerPaymentGateways/providerPaymentGateways-controller");
...
const initializeRoutes = async function (services) {
  ...
  await startProviderPaymentGatewaysRoutes(router, services.providerPaymentGatewaysService);
